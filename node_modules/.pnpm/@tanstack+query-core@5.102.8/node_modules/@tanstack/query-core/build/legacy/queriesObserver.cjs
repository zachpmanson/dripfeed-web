...
function _onUpdate(observer, result) {
	...
	if (index !== -1) {
		require_classPrivateFieldSet2._classPrivateFieldSet2(_result, this, require_classPrivateFieldSet2._classPrivateFieldGet2(_result, this).slice());
		require_classPrivateFieldSet2._classPrivateFieldGet2(_result, this)[index] = result;
		require_classPrivateFieldSet2._assertClassBrand(_QueriesObserver_brand, this, _notify).call(this);
	}
}
function _notify() {
